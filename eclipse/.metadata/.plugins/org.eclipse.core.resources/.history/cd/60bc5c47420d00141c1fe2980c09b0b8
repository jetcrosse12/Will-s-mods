...
public class MyCode {
	...
	public static Item deathBallLauncher;
	...
	public static void MyBlocks(){
		...
		//Harden Dirt
         ...
         .setBlockTextureName("yourmodsname:my_dragon_egg");
			...
			//Super Ice
		 superice = new MyBlockSlide(Material.ground)
         .setHardness(2.0F)
         .setStepSound(Block.soundTypeGravel)
         .setBlockName("Super_Ice")
         .setCreativeTab(CreativeTabs.tabBlock)
         .setBlockTextureName("ice");
		 
		 //Super TnT
		 supertnt = new MyTntBlock(Material.ground)
         .setHardness(2.0F)
         .setStepSound(Block.soundTypeGravel)
		 ...
		 //Tin Ore
		 tinOre = new BaseBlock(Material.iron)
		 .setHardness(4.0F)
         .setStepSound(Block.soundTypeStone)
         .setBlockName("tinore")
         .setCreativeTab(CreativeTabs.tabBlock)
         .setBlockTextureName("yourmodsname:tin_ore");
		 ...
		 GameRegistry.registerBlock(superice, "Super_Ice");
	...
	//Shaped 
		...
		//This recipe is so expensive because pumpkin pie is hard to make
		 ...
		 //Diamond Steel sword
		 GameRegistry.addRecipe(new ItemStack(Items.diamond_sword, 1), new Object[]
				 {
				 " A ", " A ", " B " ,
		...
		//Steel sword
		 GameRegistry.addRecipe(new ItemStack(steelSword, 1), new Object[]
				 {
				 " A ", " A ", " B " ,
				 'A', new ItemStack(steelIngot) ,
				 'B', new ItemStack(Items.stick)
				 });
		
		 //axe
		 GameRegistry.addRecipe(new ItemStack(Items.diamond_axe) , new Object[]
				 {
			     "AA ", "AB ", " B " ,
			     'A', new ItemStack(Items.diamond) ,
			     'B', new ItemStack(Items.blaze_rod)
		...
		//steel axe
		 ...
		 //axe 2 
		 GameRegistry.addRecipe(new ItemStack(Items.diamond_pickaxe) , new Object[]
				 {
			     "AAA", " B ", " B " ,
			     'A', new ItemStack(Items.diamond) ,
			     'B', new ItemStack(Items.blaze_rod)
		 ...
		 //steel hoe
		 GameRegistry.addRecipe(new ItemStack(steelHoe) , new Object[]
				 {
			     " AA", " B ", " B " ,
			     'A', new ItemStack(steelIngot) ,
			     'B', new ItemStack(Items.stick)
	...
	//Smelting
		...
		//Cookie Cooked Steak
			GameRegistry.addSmelting(new ItemStack(Items.dye, 1, 3), new ItemStack(hardOre, 1), 1.0F);
	...
	public static void MyItems()
	{
		...
		deathBallLauncher = new BaseItem()
		.setMaxStackSize(8)
		.setUnlocalizedName("death_ball");
		 ...
		 */
		 ...
		 steelSword = new BaseItem()
		 .setMaxStackSize(1)
		 .setUnlocalizedName("steel_sword");
		 
		 steelAxe = new BaseItem()
		 .setMaxStackSize(1)
		 .setUnlocalizedName("steel_axe");
		 
		 
		 steelHoe = new BaseItem()
		 .setMaxStackSize(1)
		 .setUnlocalizedName("steel_hoe");
		 
		 
		 steelShovel = new BaseItem()
		 .setMaxStackSize(1)
		 .setUnlocalizedName("steel_shovel");
		 
		 
		 steelPickaxe = new BaseItem()
		 .setUnlocalizedName("steel_Pickaxe")
		 .setTextureName("steel_pickaxe");
